    ...
    <div class="section section-basic">
        <div class="container">
            ...
            <div id="images">
                ...
                <br>
                <div class="row">
                    <form action="{{ route('bus.getTiket') }}" method="POST">
                        @csrf
                        <select name="kota_awal" id="input">
                        @foreach ($kotaBer as $k1)
                            <option value="{{ $k1->id }}">{{ $k1->nama_kotaber }}</option>
                        @endforeach
                        </select>
                        <select name="kota_tujuan" id="input">
                            @foreach ($kotaTuj as $k2)
                            <option value="{{ $k2->id }}">{{ $k2->nama_kotatuj }}</option>
                            @endforeach
                        </select>
                        ...
                        <button name="button" tipe="submit" class="btn btn-primary" >CARI TIKET</button>
                    </form>
                </div>
                <br><br><br>
                <div class="row">
