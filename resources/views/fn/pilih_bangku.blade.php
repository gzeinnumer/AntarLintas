    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                        <a class="nav-link btn btn-primary btn-round" rel="tooltip" title="" data-placement="bottom" href="{{ route('log.logout') }}" data-original-title="Follow us on Twitter">
                                    LOGOUT
                                </a>
                        </li>
    ...
    <div class="section section-basic">
        <div class="container">
            ...
            <div id="images">
                ...
                <div class="row">
                    {{-- <p>{{ $data->id }}</p> --}}
                    <form action="{{ route('bus.prosesTiket') }}" method="POST">
                        @csrf
                        <table>
                        <tr><td><input name="id_jadwal" placeholder="id_jadwal" type="text" value="{{ $data->id }}"/></td></tr>
                        <tr><td><input name="id_pengguna" placeholder="id_pengguna" type="text" value="{{ $id_ses }}"/></td></tr>
                        <tr><td><input name="jumlah_seat" placeholder="jumlah_seat" type="text"/></td></tr>
                        <tr><td>
                            <select name="id_seat">
                                @foreach ($data_seat as $d)
                                    <option value="{{ $d->id }}">{{ $d->nomor }}</option>
                                @endforeach
                            </select>
                        </td></tr>
                        <tr><td><input name="status" placeholder="status" type="text" value="0"/></td></tr>
                        <tr><td><input name="alamatjem" placeholder="alamatjem" type="text"/></td></tr>
                        <tr><td><input name="alamatant" placeholder="alamattant" type="text"/></td></tr>
                        <tr><td><input name="tglorder" placeholder="tglorder" type="date" value="{{ $data->tanggal }}"/></td></tr>
                        <tr><td><input name="total_bayar" placeholder="total_bayar" type="text"/></td></tr>
                        <tr><td><input name="bukti" placeholder="total_bayar" type="text" value="1"/></td></tr>
                        <tr><td><input type="submit" value="PESAN"></td></tr>
                        </table>
                    </form> 
                </div>
                <br><br><br>
